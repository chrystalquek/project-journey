...
export const COMMITMENT_APPLICATION_STATUS = [
  "pending",
  "accepted",
  "rejected",
] as const;
export type CommitmentApplicationStatus =
  typeof COMMITMENT_APPLICATION_STATUS[number];
...
export type CommitmentApplicationData = Omit<
  ExtractProps<typeof CommitmentApplicationSchema>,
  "__v" | "_id" | "volunteerId"
> & { _id: string; volunteerId: string };
...
export default mongoose.model<CommitmentApplicationModel>(
  "CommitmentApplication",
  CommitmentApplicationSchema
);
