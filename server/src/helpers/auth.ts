...
export const createProtectedRouter = (router: Router): Router => (config.disableAuthentication && config.env === 'development' // production and staging must have protected routes
  ? router
