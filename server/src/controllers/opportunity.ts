...
} from "../types/request/opportunity";
import {
  CreateOpportunityResponse,
  DeleteOpportunityResponse,
  GetOpportunityResponse,
  UpdateOpportunityResponse,
} from "../types/response/opportunity";
...
const getOpportunity = async (
  ...
  try {
    ...
    if (
      ...
      opportunity.volunteerType === "committed"
    ) {
...
const deleteOpportunity = async (
  req: DeleteOpportunityRequest,
  res: DeleteOpportunityResponse
): Promise<void> => {
  try {
