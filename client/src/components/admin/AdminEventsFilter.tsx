...
import {EventFilterOptions} from "@type/event";
...
type AdminEventsFilterProps = {
  ...
  setFilters: (EventFilterOptions) => void
}
    ...
    <>
      ...
      >
        ...
        <AccordionDetails>
          <FormGroup>
            <FormControlLabel
              control={<Checkbox checked={filters.eventType.volunteering}
                                 onChange={handleCheckboxChange}
                                 name={EventFilters.VOLUNTEERING} />}
              label={EventFilters.VOLUNTEERING}
            />
            <FormControlLabel
              control={<Checkbox checked={filters.eventType.workshops}
                                 onChange={handleCheckboxChange}
                                 name={EventFilters.WORKSHOPS} />}
              label={EventFilters.WORKSHOPS}
            />
            <FormControlLabel
              control={<Checkbox checked={filters.eventType.hangouts}
                                 onChange={handleCheckboxChange}
      ...
      >
        ...
        <AccordionDetails>
          <FormGroup>
            <FormControlLabel
              control={<Checkbox checked={filters.volunteerType.adhoc}
                                 onChange={handleCheckboxChange}
                                 name={EventFilters.ADHOC} />}
              label={EventFilters.ADHOC}
            />
            <FormControlLabel
              control={<Checkbox checked={filters.volunteerType.committed}
                                 onChange={handleCheckboxChange}
